...
fusionSites =
  ...
  , "    server_name         bz-ext.fusionapp.com bz.fusionapp.com prod.fusionapp.com bn.fusionapp.com;"
  ...
  , "    add_header Content-Security-Policy-Report-Only \"img-src 'self'; style-src blob: 'self' 'unsafe-inline'; connect-src 'self'; script-src 'self' 'unsafe-inline'; form-action 'self'; frame-ancestors 'none'; report-uri https://fusionapp.report-uri.com/r/d/csp/wizard\";"
  , ""
  , "    location /fusion-error {"
  , "        root            /srv/nginx;"
  , "    }"
