...
fusionSites =
  ...
  , "    root                /srv/nginx;"
  , "    access_log          /var/log/nginx/${host}.access.log fusion;"
  , "    gzip                on;"
  , "    gzip_proxied        any;"
  , "    gzip_disable        msie6;"
  , "    gzip_comp_level     9;"
  ...
  , "    server_name         bz-ext.fusionapp.com bz.fusionapp.com;"
  , "    root                /srv/nginx;"
  , "    access_log          /var/log/nginx/${host}_tls.access.log fusion;"
  , "    ssl_certificate     /srv/certs/private/star.fusionapp.com.pem;"
  , "    ssl_certificate_key /srv/certs/private/star.fusionapp.com.pem;"
  , "    gzip                on;"
  , "    gzip_proxied        any;"
...
quotemasterSite =
  ...
  , "    ssl_certificate     quotemaster.co.za.pem;"
  , "    ssl_certificate_key quotemaster.co.za.pem;"
  , "    ssl_ciphers         ECDH+AESGCM:DH+AESGCM:ECDH+AES256:DH+AES256:ECDH+AES128:DH+AES:ECDH+3DES:DH+3DES:RSA+AES:RSA+3DES:!ADH:!AECDH:!MD5;"
  , "    ssl_prefer_server_ciphers on;"
  , "    ssl_protocols       TLSv1 TLSv1.1 TLSv1.2;"
  , "    ssl_session_cache   shared:SSL:50m;"
