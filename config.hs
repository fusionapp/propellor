...
scarlet = host "scarlet.fusionapp.com" $ props
          ...
          & File.hasPrivContent "/srv/db/clj-documint/documint_keystore_uat.jks" (Context "fusion uat")
...
caddyfile = propertyList "Configuration for Caddy" $ props
  ...
  [ "https://rancher.fusionapp.com:443, https://rancher.fusionapp.com:4433, http://rancher.fusionapp.com:80, http://rancher.fusionapp.com:8071"
  , "gzip"
  , "log stdout"
